...
public class ApplicationContext
{
    ...
    public IEshopCommand CreateCommand(CommandType commandType)
    {
        ...
        return commandType switch
        {
            ...
            CommandType.AddProductToBasket => new AddBasketLineCommand(repositoryFactory.CreateBasketRepository(), (repositoryFactory.CreateProductRepository())!),
            CommandType.AddServiceToBasket => new AddBasketLineCommand(repositoryFactory.CreateBasketRepository(), (null)!),

...
public class ApplicationContext
{
    ...
    public IEshopCommand CreateCommand(CommandType commandType)
    {
        ...
        return commandType switch
        {
            ...
            CommandType.DisplayProducts => new DisplayProductsCommand(repositoryFactory.CreateSaleItemAsyncRepository()),
            CommandType.DisplayServices => new DisplayServicesCommand(repositoryFactory.CreateSaleItemAsyncRepository()),

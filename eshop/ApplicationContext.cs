...
public class ApplicationContext
{
    ...
    public IEshopCommand CreateCommand(CommandType commandType)
    {
        return commandType switch
        {
            ...
            CommandType.AddProductToBasket => new AddBasketLineCommand(_repositoryFactory.CreateBasketRepository(), _repositoryFactory.CreateProductRepository().GetAll()),
            CommandType.AddServiceToBasket => new AddBasketLineCommand(_repositoryFactory.CreateBasketRepository(), _repositoryFactory.CreateServiceRepository().GetAll()),

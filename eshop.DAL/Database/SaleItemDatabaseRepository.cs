...
namespace eshop.DAL.Database
{
    ...
    /// </summary>
    public class SaleItemDatabaseRepository : BaseRepository, IReadOnlyRepository<SaleItem>
    {
        public SaleItemDatabaseRepository(DatabaseContext databaseContext) : base(databaseContext)
        {
        }
